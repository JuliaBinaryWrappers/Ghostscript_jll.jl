# Autogenerated wrapper script for Ghostscript_jll for aarch64-apple-darwin
export dvipdf, eps2eps, gs, gsbj, gsdj, gsdj500, gserrors_h, gslj, gslp, gsnd, iapi_h, ierrors_h, libgs, pdf2dsc, pdf2ps, pf2afm, pfbtopfa, pphs, printafm, ps2ascii, ps2epsi, ps2pdf, ps2pdf12, ps2pdf13, ps2pdf14, ps2pdfwr, ps2ps, ps2ps2
...
JLLWrappers.@declare_library_product(libgs, "@rpath/libgs.dylib.9.55")
