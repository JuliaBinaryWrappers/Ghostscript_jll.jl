# Autogenerated wrapper script for Ghostscript_jll for armv7l-linux-musleabihf
export dvipdf, eps2eps, gs, gsbj, gsdj, gsdj500, gslj, gslp, gsnd, pdf2dsc, pdf2ps, pf2afm, pfbtopfa, pphs, printafm, ps2ascii, ps2epsi, ps2pdf, ps2pdf12, ps2pdf13, ps2pdf14, ps2pdfwr, ps2ps, ps2ps2
...
function __init__()
    JLLWrappers.@generate_init_header(Libtiff_jll)
